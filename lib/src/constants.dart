const String how_to_work = '''
Bu uygulama "FakeMail.net" adresini kazıyarak işlem yapar, eğer kazınan web sitenin sahibinden biriyseniz bu uygulamanın sadece öğrenme amaçlı yapıldığını, herhangi bir mobile app olarak yayınlanmayacağını sadece githubda duracağını bilmenizi isterim.
